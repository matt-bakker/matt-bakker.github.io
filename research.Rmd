...
```{r, cache = FALSE, echo = FALSE, fig.cap = "*Image by Peter Schill, via wikimedia CC BY-SA 2.0 de*", dpi = 96}
...
<div style= "float:right;position: relative; top: -700px;">
```{r, cache = FALSE, echo = FALSE, fig.cap = "*Chemical structure of the mycotoxin deoxynivalenol*", dpi = 96}
