...
```{r, cache = FALSE, echo = FALSE, fig.cap = "*Fusarium head blight; image curtesy of U.S. Department of Agriculture*"}
...
```{r, cache = FALSE, echo = FALSE, fig.cap = "*Image by Peter Schill, via wikimedia CC BY-SA 2.0 de*"}
knitr::include_graphics("media/Malt_viaWikipedia_1280px-Grünmalz.jpg", dpi = 200)
