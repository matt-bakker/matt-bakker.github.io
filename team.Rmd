...
knitr::include_graphics("media/Wog_Kelsey.png")
```
...
*Fusarium graminearum*. Kelsey is a fellow of the [EvoFunPath training
program](https://evofunpath.ibis.ulaval.ca/){target="_blank"}.
...
### Avery Hoeppner
*Co-op student + undergraduate student research awardee.*\
