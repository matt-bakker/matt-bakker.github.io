...
```{r echo = FALSE, fig.align = "right", out.width = '30%', out.extra = 'style = "float:right; padding:10px"'}
knitr::include_graphics("media/Volakaki_Anna.jpeg")
```

### [Anna Volakaki](https://www.linkedin.com/in/anna-maria-volakaki-3626b1295/){target="_blank"}
*PhD student (co-advised with [Dr. Olivia Wilkins](https://www.oliviawilkinslab.com/){target="_blank"}).*\
...
[Kyle Remillard](https://www.linkedin.com/in/kyle-remillard-23628a312/){target="_blank"}, *Undergraduate summer research*
